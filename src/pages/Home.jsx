...
function Home() {
    ...
    return loading ?
        (<div className="min-h-[400px] flex justify-center items-center mt-36 " role="status">
            ...
            (posts.length > 0) ? (<div className="w-full py-8">
                <Container>
                    <div className="flex justify-center flex-wrap mt-12 sm:mt-36 gap-10">
                        {posts.map((post) => (
                            <div key={post.$id}>
                                <PostCard {...post} />
                            </div>
            ...
            </div>) : (<div className="w-full min-h-[400px] py-8 mt-36 flex justify-center items-center">
